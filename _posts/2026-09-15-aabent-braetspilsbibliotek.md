...
image: "/assets/images/nyheder/bibliotek3.jpg"
...
1. Gå på opdagelse i biblioteket.
2. Find et spil, du har lyst til at prøve.
3. Lån det.
4. Find et ledigt bord og nogle medspillere.
5. Aflever spillet igen, når I er færdige.
...
**Udvalg:** Et par hundrede brætspil  
**Forkundskaber:** Ingen
...
<ul>
  ...
  <li>Decrypto</li>
  <li>Deep Sea Adventure</li>
  <li>Descent: Journeys in the Dark</li>
  <li>Dice Stars</li>
  <li>Dice Throne: Barbarian vs. Moon Elf</li>
  <li>Dice Throne: Gunslinger vs. Samurai</li>
  <li>Disney Villainous</li>
  <li>Disney Villainous: The Worst Takes It All</li>
  <li>Dixit</li>
  <li>Dominion</li>
  <li>Dragon Castle</li>
  <li>Drillers</li>
  ...
  <li>Marrakech</li>
  <li>Marvel Champions: The Card Game</li>
  ...
  <li>Unmatched: Battle of Legends, Volume One</li>
  <li>Unmatched: Cobble & Fog</li>
  <li>Unmatched: Robin Hood vs. Bigfoot</li>
  <li>Village Pillage + Surf & Turf</li>
  <li>Virus!</li>
